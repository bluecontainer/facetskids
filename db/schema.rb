...
ActiveRecord::Schema.define(version: 20140731214712) do
  ...
  create_table "supporting_role_types", force: true do |t|
    t.string "name"
  end

  create_table "supporting_roles", force: true do |t|
    t.integer "person_id"
    t.integer "video_id"
    t.integer "supporting_role_type_id"
  end
